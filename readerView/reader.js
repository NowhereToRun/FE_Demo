...
; (function (win) {
    ...
    CandidateElement = function (e, t) {
        ...
        this.contentDocument = e, this.didSearchForArticleNode = !1, this.article = null,
            // this.didSearchForExtraArticleNode = !1, 
            // this.extraArticle = null, 
            // this.leadingImage = null, 
            this._cachedScrollY = 0, this._cachedScrollX = 0, this._elementsWithCachedBoundingRects = [], this._cachedContentTextStyle = null,
            // this.pageNumber = 1, 
            this.prefixWithDateForNextPageURL = null, this._elementsEvaluatedForTextContent = [], this.previouslyDiscoveredPageURLStrings = []
        ...
        // },    
        isReaderModeAvailable: function () {
            return this.canRunReaderDetection() ? (this.cacheWindowScrollPosition(), this.article = this.findArticleByVisualExamination(), !!this.article) : null
        },
        ...
        // }, 
        articleNode: function (t) {
            return this.didSearchForArticleNode || ((this.article = this.findArticleBySearchingAllElements()), this.article || (this.article = this.findArticleByVisualExamination()), !this.article && t && (this.article = this.findArticleBySearchingAllElements(!0)), this.adjustArticleNode(), this.didSearchForArticleNode = !0, this.article), this.article ? this.article.element : null
        },
        ...
        shouldPruneElement: function (t, n) {
            ...
            if (a === "OBJECT") {
                ...
                return T = N ? anchorForURL(N, this.contentDocument) : null, T && false ? !1 : !0
            }
    ...
    win.ReaderArticleFinderJS = new ReaderArticleFinder(document);
})(window)
